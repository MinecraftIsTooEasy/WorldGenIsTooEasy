...
public class RealisticBiomeTaigaPlains extends RealisticBiomeBase {
    ...
    public RealisticBiomeTaigaPlains() {
        ...
        surface = new SurfaceTundra(Block.grass, Block.dirt);
    }
    ...
    public void rDecorate(World world, Random rand, int chunkX, int chunkY, NoiseGenerator perlin, CellNoise cell,
        ...
        if (rand.nextInt((int) (15f / strength)) == 0) {
            ...
            if (l4 > 63) {
                (new WorldGenLakes(Block.waterStill.blockID)).generate(world, rand, i2, l4, i8);
            }
        }
        ...
        for (int l = 0; l < 3f * strength; ++l) {
            ...
            if (k1 < 95 && (k1 < 64 || rand.nextInt(7) == 0)) {
                (new DecoBlob(Block.cobblestoneMossy, 0)).generate(world, rand, i1, k1, j1);
            }
        }
        ...
        for (int b1 = 0; b1 < l * 4f * strength; b1++) {
            ...
            WorldGenerator worldgenerator = rand.nextInt(4) == 0 ? new DecoSmallSpruce(1 + rand.nextInt(2))
                    : rand.nextInt(6) == 0 ? new DecoSmallPine(1 + rand.nextInt(3), 4 + rand.nextInt(4))
                    : new DecoSmallPine(4 + rand.nextInt(6), 5 + rand.nextInt(10));
        ...
        if (rand.nextInt((int) (3f / strength)) == 0) {
            ...
            if (rand.nextBoolean()) {
                (new WorldGenFlowers(Block.mushroomBrown.blockID)).generate(world, rand, k15, k17, k20);
            } else {
                (new WorldGenFlowers(Block.mushroomRed.blockID)).generate(world, rand, k15, k17, k20);
            }
        }
        ...
        for (int f23 = 0; f23 < 4f * strength; f23++) {
            ...
            (new DecoFlowers(1, 2, flowerMeta)).generate(world, rand, j15, j17, j20);
        }
