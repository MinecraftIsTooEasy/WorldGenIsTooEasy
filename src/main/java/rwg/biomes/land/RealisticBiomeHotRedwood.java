...
public class RealisticBiomeHotRedwood extends RealisticBiomeBase {
    ...
    public RealisticBiomeHotRedwood() {
        super(0, RWGBaseBiomes.baseHotForest, RWGBiomes.coastDunes, RWGBaseBiomes.baseRiverHot);

        terrain = new TerrainGrasslandFlats();
        surface = new SurfaceGrasslandMixBig(
                Block.sand,
                Block.sand,
                Block.grass,
                Block.dirt,
    ...
    public void rDecorate(World world, Random rand, int chunkX, int chunkY, NoiseGenerator perlin, CellNoise cell,
        ...
        for (int b1 = 0; b1 < l * 4f * strength; b1++) {
            ...
            WorldGenerator worldgenerator = rand.nextInt(6) == 0 ? new WorldGenTrees(false)
                    : rand.nextInt(12) == 0 ? new DecoBirch(4 + rand.nextInt(5), 6 + rand.nextInt(5))
                    : rand.nextInt(6) == 0 ? new DecoSmallPine(3 + rand.nextInt(2), 3 + rand.nextInt(3), 0)
                    : new DecoSmallPine(6 + rand.nextInt(5), 3 + rand.nextInt(6), 0);
