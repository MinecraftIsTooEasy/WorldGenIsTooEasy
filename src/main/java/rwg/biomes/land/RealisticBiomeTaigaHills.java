        ...
        for (int b1 = 0; b1 < l * strength; b1++) {
            ...
            if (z52 < 90) {
                WorldGenerator worldgenerator = rand.nextInt(10) != 0
                        ? new DecoPineTree(4, 1)
                        : rand.nextInt(3) != 0 ? new DecoSmallPine(3 + rand.nextInt(6), 6 + rand.nextInt(8), 1)
                        : new DecoSmallSpruce(rand.nextInt(2) + 1);
                worldgenerator.setScale(1.0D, 1.0D, 1.0D);
                worldgenerator.generate(world, rand, j6, z52, k10);
            } else if (z52 < 120) {
                WorldGenerator worldgenerator = rand.nextInt(4) != 0
                        ? new DecoSmallPine(1 + rand.nextInt(3), 3 + rand.nextInt(5), rand.nextInt(2))
