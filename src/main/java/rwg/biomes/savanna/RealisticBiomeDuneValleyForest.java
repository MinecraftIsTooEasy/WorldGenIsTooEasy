...
public class RealisticBiomeDuneValleyForest extends RealisticBiomeBase {
    ...
    public RealisticBiomeDuneValleyForest() {
        ...
        surface = new SurfaceDuneValley(Block.grass, Block.dirt, 220f, false, true);
    }
    ...
    public void rDecorate(World world, Random rand, int chunkX, int chunkY, NoiseGenerator perlin, CellNoise cell,
        ...
        if (t > 0f) {
            if (rand.nextInt((int) ((10f - t) / strength)) == 0) {
                ...
                if (z52 < 82) {
                    WorldGenerator worldgenerator = new DecoJungleTall(
                            Block.wood,
                            2,
                            Block.leaves,
                            2,
        ...
        if (river > 0.8f) {
            for (int b33 = 0; b33 < 8f * strength; b33++) {
                ...
                if (z52 < 82) {
                    WorldGenerator worldgenerator = rand.nextInt(2) != 0 ? new WorldGenShrub(0, 0)
            ...
            for (int b33 = 0; b33 < (1f + t) * strength; b33++) {
                ...
                if (z52 < 82) {
                    WorldGenerator worldgenerator = rand.nextInt(6) != 0 ? new WorldGenShrub(0, 0)
                            : new DecoSavannah(1, false);
                    worldgenerator.setScale(1.0D, 1.0D, 1.0D);
                    worldgenerator.generate(world, rand, j6, z52, k10);
                }
        ...
        for (int k18 = 0; k18 < 16f * strength; k18++) {
