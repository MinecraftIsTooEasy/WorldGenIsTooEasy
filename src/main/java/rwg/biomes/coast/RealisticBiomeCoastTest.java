...
public class RealisticBiomeCoastTest extends RealisticBiomeBase {
    ...
    public RealisticBiomeCoastTest() {
        super(0, RWGBaseBiomes.baseRiverOasis);
    }
    ...
    public float rNoise(NoiseGenerator perlin, CellNoise cell, int x, int y, float ocean, float border, float river) {
        ...
        /*
         * float h = ocean * 10f; h += perlin.noise2(x / 12f, y / 12f); h += perlin.noise2(x / 20f, y / 20f) * 2;
         * if(ocean > 1f) { h += perlin.noise2(x / 9f, y / 9f) * (ocean - 1f); } return h + 55f;
         */
