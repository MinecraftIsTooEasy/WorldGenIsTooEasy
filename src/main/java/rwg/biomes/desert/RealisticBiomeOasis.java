...
public class RealisticBiomeOasis extends RealisticBiomeBase {
    ...
    public RealisticBiomeOasis() {
        super(0, RWGBaseBiomes.baseOasis, RWGBiomes.coastDunes, RWGBaseBiomes.baseRiverOasis);
        terrain = new TerrainHilly(230f, 120f, 20f, 60f, 63f);
        surface = new SurfaceDesertOasis(Block.grass, Block.dirt, Block.stone, Block.cobblestone, (byte) 0, 0);
        ...
        for (int b33 = 0; b33 < 4f * strength; b33++) {
            ...
            if (z52 < 71f) {
                WorldGenerator worldgenerator = rand.nextInt(4) != 0 ? new WorldGenShrub(0, 0)
                        : rand.nextInt(6) == 0 ? new DecoPalm() : new DecoSavannah(1, false);
