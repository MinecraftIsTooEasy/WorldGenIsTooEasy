...
public class RealisticBiomeDarkRedwood extends RealisticBiomeBase {
    ...
    public RealisticBiomeDarkRedwood() {
        super(0, RWGBaseBiomes.baseColdForest, RWGBiomes.coastDunes, RWGBaseBiomes.baseRiverTemperate);
    ...
    public void rDecorate(World world, Random rand, int chunkX, int chunkY, NoiseGenerator perlin, CellNoise cell,
        ...
        float l = perlin.noise2(chunkX / 80f, chunkY / 80f) * 60f + 10f;
            ...
            if (rand.nextInt(6) == 0) {
                ...
                if (z52 < 110) {
                    WorldGenerator worldgenerator = new DecoLargePine(
                            (int) (14 - ((z52 - 70) / 5f)) + rand.nextInt(6),
                            (int) (15 - ((z52 - 70) / 5f)) + rand.nextInt(10),
                            1,
                            1);
