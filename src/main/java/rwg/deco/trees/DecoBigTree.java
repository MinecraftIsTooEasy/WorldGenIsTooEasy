...
public class DecoBigTree extends WorldGenerator {
    ...
    public DecoBigTree(int sizeinput, int typeinput) {
        size = sizeinput;
        type = typeinput;
    }
        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
            ...
            while (var13 <= var7) {
                ...
                if (var15 > (double) (par4 * par4)) {
                    ...
                    if (var14 != null && var14 != Block.leaves) {
                        ++var13;
                    } else {
                        worldObj.setBlock(var11[0], var11[1], var11[2], par6.blockID, 0, 0);
                        ++var13;
                    }
                }
            }
    ...
    void generateLeafNode(int par1, int par2, int par3) {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) { // /bwg4 made by ted80
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte) 1, Block.leaves);
        }
    }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3) {
        ...
        if (var4[var6] != 0) {
            ...
            for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
                ...
                worldObj.setBlock(var14[0], var14[1], var14[2], par3.blockID, 0, 0);
            }
        }
    }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, Block.wood);
    ...
    void generateLeafNodeBases() {
        ...
        for (int[] var3 = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1) {
            ...
            if (this.leafNodeNeedsBase(var6)) {
                this.placeBlockLine(var3, var5, Block.wood);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        if (var3[var5] == 0) {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                if (var16 != null && var16 != Block.leaves) {
                    break;
                }
            }
    ...
    boolean validTreeLocation() {
        ...
        if (var3 != Block.grass && var3 != Block.dirt) {
            return false;
        } else {
