...
public class DecoJungleTall extends WorldGenerator {
    ...
    public DecoJungleTall(Block log, int metaLog, Block leaves, int metaLeaves, int baseHeight, int rootHeight,
